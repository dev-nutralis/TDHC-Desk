...
import {
  Plus, Pencil, Trash2, GripVertical, Loader2, AlertTriangle, X, LayoutList, Download,
} from "lucide-react";
      ...
      <div className="relative z-10 w-full max-w-sm bg-white rounded-xl overflow-hidden"
        ...
        <div className="px-5 py-4">
          <p className="text-sm text-[#68717A]">
            ...
            Any lead data stored in this field may be affected.
          </p>
...
export default function LeadFieldsManager() {
  ...
  const handleToggleActive = async (field: ContactField) => {
    ...
    await fetch(`/api/lead-fields/${field.id}`, {
      method: "PUT",
