...
interface SectionColumnProps {
  ...
  onDragEnd: () => void;
  onToggleVisible: (section: "contact_info" | "details", key: string) => void;
  onRemove: (section: "contact_info" | "details", key: string) => void;
  onAdd: (field: AvailableField, section: "contact_info" | "details") => void;
}
...
export default function ProfileLayoutPage() {
  const [contactInfoFields, setContactInfoFields] = useState<FieldConfig[]>([]);
  ...
  async function load() {
    ...
    try {
      ...
      const ci: FieldConfig[] = data.configs
        .filter((c: { section: string }) => c.section === "contact_info")
  ...
  function getFields(section: "contact_info" | "details") {
    return section === "contact_info" ? contactInfoFields : detailFields;
  }
  ...
  function handleDrop(targetKey: string | null, targetSection: string) {
    ...
    const sourceSection = draggingSection as "contact_info" | "details";
    const destSection = targetSection as "contact_info" | "details";
  ...
  function handleRemove(section: "contact_info" | "details", key: string) {
  ...
  async function handleSave() {
    ...
    try {
      const configs = [
        ...contactInfoFields.map((f, i) => ({
          field_key: f.field_key,
          section: "contact_info" as const,
          sort_order: i,
    ...
    <div className="flex flex-col h-full">
      ...
      <div className="mb-6">
        ...
        <p className="text-sm text-[#68717A] mt-1">
          Configure which fields appear on the Contact Detail page and how they
          are arranged.
        </p>
      </div>
